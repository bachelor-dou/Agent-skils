...
class TestTrendingParser:
    def test_parse_trending_html_basic(self):
        ...
        from hot_projects.providers.github.trending import _parse_trending_html
    ...
    def test_parse_number(self):
        from hot_projects.providers.github.trending import _parse_number
    ...
    def test_fetch_trending_success(self):
        ...
        with patch("hot_projects.providers.github.trending.requests.get", return_value=mock_resp):
            from hot_projects.providers.github.trending import fetch_trending
    ...
    def test_fetch_trending_network_error(self):
        ...
        with patch(
            "hot_projects.providers.github.trending.requests.get",
            side_effect=req.RequestException("timeout"),
        ) as mock_get:
            with patch("hot_projects.providers.github.trending.time.sleep") as mock_sleep:
                from hot_projects.providers.github.trending import fetch_trending
    ...
    def test_fetch_trending_invalid_since(self):
        ...
        with patch("hot_projects.providers.github.trending.requests.get", return_value=mock_resp) as mock_get:
            from hot_projects.providers.github.trending import fetch_trending
...
class TestTrendingAll:
    def test_fetch_trending_all_dedup(self):
        ...
        with patch("hot_projects.providers.github.trending.requests.get", return_value=mock_resp):
            from hot_projects.providers.github.trending import fetch_trending_all

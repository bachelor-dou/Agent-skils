...
class TestGrowthBinary:
    ...
    def test_below_threshold_returns_zero(self, mock_token_mgr):
        ...
        from hot_projects.providers.github.growth_estimator import estimate_star_growth_binary
    ...
    def test_growth_in_last_page(self, mock_token_mgr):
        ...
        with patch("hot_projects.providers.github.growth_estimator.get_stargazers_page", return_value=last_page):
    ...
    def test_last_page_inaccessible_fallback_sampling(self, mock_token_mgr):
        ...
        with patch("hot_projects.providers.github.growth_estimator.get_stargazers_page", return_value=None):
            with patch("hot_projects.providers.github.growth_estimator.estimate_by_sampling", return_value=1500) as mock_sampling:
    ...
    def test_empty_last_page(self, mock_token_mgr):
        ...
        with patch("hot_projects.providers.github.growth_estimator.get_stargazers_page", return_value=[]):
            result = estimate_star_growth_binary(mock_token_mgr, "org", "repo", total_stars=5000)
            assert result == 0
...
class TestGrowthSampling:
    ...
    def test_sampling_precise_count(self, mock_token_mgr):
        ...
        from hot_projects.providers.github.growth_estimator import estimate_by_sampling
        now = datetime.now(timezone.utc)
        cutoff = now - timedelta(days=7)
        ...
        with patch("hot_projects.providers.github.growth_estimator.graphql_stargazers_batch", side_effect=mock_graphql):
            with patch("hot_projects.providers.github.growth_estimator.time.sleep"):
    ...
    def test_sampling_insufficient_data(self, mock_token_mgr):
        ...
        from hot_projects.providers.github.growth_estimator import estimate_by_sampling, GROWTH_ESTIMATION_UNRESOLVED
    ...
    def test_sampling_empty_batch(self, mock_token_mgr):
        ...
        with patch("hot_projects.providers.github.growth_estimator.graphql_stargazers_batch", return_value=([], None)):
            result = estimate_by_sampling(mock_token_mgr, "org", "repo")
            assert result == GROWTH_ESTIMATION_UNRESOLVED
    ...
    def test_sampling_respects_configured_batch_limit(self, mock_token_mgr):
        ...
        with patch("hot_projects.providers.github.growth_estimator.MAX_GRAPHQL_SAMPLING_BATCHES", 3):
            with patch("hot_projects.providers.github.growth_estimator.graphql_stargazers_batch", side_effect=mock_graphql):
                with patch("hot_projects.providers.github.growth_estimator.time.sleep"):
                    result = estimate_by_sampling(mock_token_mgr, "org", "repo")
